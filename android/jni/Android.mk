...
LOCAL_SRC_FILES := \
	...
	socks4.c socks5.c http-relay.c base.c base64.c md5.c http-auth.c utils.c redudp.c socks5-udp.c shadowsocks-udp.c \
	tcpdns.c tsearch_avl.c search.h \
	$(LOCAL_PATH)/android/version.c
...
LOCAL_STATIC_LIBRARIES := libev libevent2 libcrypto libssl
